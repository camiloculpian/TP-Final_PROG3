                ...
                <fieldset>
                    ...
                    <form onSubmit={handleSubmit}  method='PUT'>
                        ...
                        <div>
                            ...
                            <button className="botonComun" id="cancelar-editar-estudiante" type="cancel" onClick={()=>{setFormData({apellido: "",nombre: "",dni: "",fechaNacimiento: "",nacionalidad: "56",celular: "",correoElectronico: ""});}}>Cancelar</button>
                        </div>
                    </form>
                </fieldset>
            </div>
